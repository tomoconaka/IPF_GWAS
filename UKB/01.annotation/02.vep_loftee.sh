...
## 実行する
$vep38 -o $SCRATCH/chr${SLURM_ARRAY_TASK_ID}.LoF.ukb23149_450k_OQFE.variant_ID.txt.gz -i ${SCRATCH}/chr${SLURM_ARRAY_TASK_ID}.ukb23149_450k_OQFE.variant_ID.input.txt.gz \
--fa $REF_FASTA \
